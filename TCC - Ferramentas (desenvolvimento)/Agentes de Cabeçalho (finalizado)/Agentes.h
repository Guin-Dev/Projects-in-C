/*
   Lib de agentes feita por Nícolas Herculano Pires
*/

#define NUM_TOTAL_AGENTES 4255

/*
    String com os agentes para ser randomizada
*/
const char *agentsRand[NUM_TOTAL_AGENTES] = 
{
